...
import { ArrowLeft, BookOpen, Users, Globe2, Briefcase, Leaf, Building, Lightbulb } from 'lucide-react';
...
const PolicyResearchPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Reveal>
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We generate evidence and policy-oriented research to support governments, development partners, and institutions in designing more effective and inclusive policies.
            </p>
          </Reveal>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="mb-12 text-center">
             <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Research Themes</h2>
             <p className="text-gray-600 max-w-2xl mx-auto">
               Our research spans across multiple critical areas of sustainable development, focusing on actionable insights and systemic change.
             </p>
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-20 relative z-10">
          {THEMES.map((theme, idx) => (
            <Reveal key={idx} delay={idx * 50}>
               <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:border-teal-200 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center group cursor-default">
          ...
          <div className="bg-teal-900 rounded-[32px] p-12 text-center text-white relative overflow-hidden">
             ...
             <div className="relative z-10">
               ...
               <p className="text-teal-100 mb-8 max-w-2xl mx-auto">
                 Explore our library of research papers, policy briefs, and reports documenting our findings and recommendations.
               </p>
